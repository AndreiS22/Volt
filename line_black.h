...
void printState(){
  voltSerial.print(s1_c);
  voltSerial.print("  ");
  voltSerial.print(s2_c);
  voltSerial.print("  ");
  voltSerial.print(s3_c);
  voltSerial.print("  ");
  voltSerial.print(s4_c);
  voltSerial.print("  ");
  voltSerial.print(s5_c);
  voltSerial.print("  ");
  voltSerial.print(s6_c);
  voltSerial.print("  ");
  voltSerial.print(s7_c);
  voltSerial.print("  ");
  voltSerial.print(s8_c);
  voltSerial.print("  ");
  voltSerial.print(s9_c);
  voltSerial.print("  ");
  voltSerial.print(s10_c);
  voltSerial.print("  ");
  voltSerial.print(s11_c);
  voltSerial.print("  ");
  voltSerial.print(s12_c);
  voltSerial.print("  ");
  voltSerial.print(s13_c);
  voltSerial.print("  ");
  voltSerial.print(s14_c);
  voltSerial.print("  ");
  voltSerial.print(s15_c);
  voltSerial.print("  ");
  voltSerial.println(s16_c);
  delay(1);
}
